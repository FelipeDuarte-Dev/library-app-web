...
export default function BookList({ initialBooks, pagination, filters }: Props) {
  ...
  const buildPaginationUrl = (page: number) => {
    ...
    if (filters.stock_filter) {
      params.append("stock_filter", filters.stock_filter);
    }
        ...
        <form onSubmit={handleSearch}>
          ...
          {showFilters.value && (
            <div class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <select name="stock_filter" class="px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
          ...
          <div class="mt-4 flex gap-2">
            ...
            <a href="/" class="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300">
              Limpiar
            </a>
            <a href="/books/new" class="ml-auto px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">
              + Nuevo Libro
            </a>
          </div>
        </form>
